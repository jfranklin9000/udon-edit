...
gulp.task('css-bundle', function() {
  ...
  return gulp
    ...
    .pipe(gulp.dest('./urbit/app/udonedit/css'));
});
...
gulp.task('js-imports', function(cb) {
  return gulp.src('dist/index.js')
    ...
    .pipe(gulp.dest('./urbit/app/udonedit/js/'))
    .on('end', cb);
});
...
gulp.task('js-minify', function () {
  return gulp.src('./urbit/app/udonedit/js/index.js')
    .pipe(minify())
    .pipe(gulp.dest('./urbit/app/udonedit/js/'));
});

gulp.task('tile-js-minify', function () {
  return gulp.src('./urbit/app/udonedit/js/tile.js')
    .pipe(minify())
    .pipe(gulp.dest('./urbit/app/udonedit/js/'));
});
